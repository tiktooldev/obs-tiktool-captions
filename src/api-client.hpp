...
// Thin Qt-network wrapper over the public TikTools REST surface used by the
...
public:
    ...
    void    setFingerprint(const QString &fp) { fingerprint_ = fp; }
    void    setClaimFingerprint(const QString &fp) { fingerprint_ = fp; }
